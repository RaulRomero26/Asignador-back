...
const { crearTarea,getAllTareas,handleFile,getTareaById,getTareasVigilanciaHoy, actualizarTarea, crearTareaGuardia  } = require('../controllers/tareas.controller');
...
router.post('/tarea-guardia', handleFile, crearTareaGuardia )
